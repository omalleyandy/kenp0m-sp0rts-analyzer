# KenPom Official API Documentation

**Source**: kenpom.com API documentation (retrieved 2025-12-15)
...
This is a markdown conversion of the official KenPom API documentation for easier reference and version control.

## Quick Reference

- [Ratings](#ratings) - Team efficiency ratings and metrics
- [Archive](#archive) - Historical ratings from specific dates
- [Four Factors](#four-factors) - Dean Oliver's Four Factors
- [Point Distribution](#pointdist) - FT, 2pt, 3pt scoring breakdown
- [Height](#height) - Team height and experience
- [Miscellaneous Stats](#misc-stats) - Advanced shooting and assist metrics
- [Fanmatch](#fanmatch) - Game predictions
- [Teams](#teams) - Team list with metadata
- [Conferences](#conferences) - Conference list
...
| `RankOppStlRate` | integer | Opponent steal rate (defense) |
...
Retrieve game predictions for a specific date, including team rankings, predicted scores, win probabilities, tempo predictions, and thrill scores.
...
### Parameter Naming
The official API uses abbreviated parameter names:
- `y` for year/season
- `c` for conference
- `d` for date

The Python API client (`api_client.py`) provides both abbreviated and full parameter names for convenience.

### Response Field Types
- Fields marked as `string` type may contain "true"/"false" values (e.g., `Preseason`, `ConfOnly`)
- The Python API client automatically converts these to boolean values

### Team IDs
Team IDs are consistent across seasons and can be found using the Teams endpoint. Common examples:
- Duke: 73
- North Carolina: 153
- Kentucky: 96

### Conference Abbreviations
Conference short names (e.g., "ACC", "B12", "SEC") can be found using the Conferences endpoint.
