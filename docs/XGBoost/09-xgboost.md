...
- Core jargon
- Boosting benefits and downside
- Inspecting trees/output

## Core ideas (LLM-friendly)
- Boosting builds trees sequentially: each new tree tries to fix the previous model’s mistakes.
- XGBoost adds regularization, shrinkage (learning rate), and system optimizations for speed.
- Downside: boosted models can overfit and need careful validation / early stopping.
